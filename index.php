    ...
    <body>
		...
		<header>
            <div class="header-content">
                <div class="logo">
                    <a href="index.php"><img src="images/logo.png" height="70px" alt=""></a>
                </div>
                <?php
        ...
        <div id="footer">
            <ul class="footer-top">
                <li>
                    <div class="place">
                        <a style="font-weight: bold;font-size: 15px;">Địa chỉ thư viện</a>
                        <br>
                        <a>
                ...
                <li>
                    <div class="introduce">
                        <div style="font-size: 15px;font-weight: bold;">Thư viện</div>
                        <a href="#">Giới thiệu</a>
                        <br>
                        <a href="#">Quy định thư viện</a>
                    </div>
                </li>
                <li>
                    <div class="call">
        ...
        <!--------------- logo cố định ----------------->
        <div class="logo_call" >
            <li><a href="https://facebook.com" class="button" target="_blank" style="border-radius: 50%; width: 50px;height: 50px; "><i class="fa fa-facebook"></i></a></li>
        </div>
