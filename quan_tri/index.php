...
<body>
    <div id="wrapper">
        <div id="header">
            <li><a href="index.php"><img src="anh/logo.png" height="30px" alt=""></a></li>
        ...
        <div id="wp-content">
            <div class="sidebar">
                ...
                <li><a href="index.php?page_layout=danhsachtv"><i class="fa fa-users"></i>Quản lí thành viên</a></li>
                <li><a href="index.php?page_layout=danhsachdm"><i class="fa fa-list-ul"></i>Quản lí danh mục</a></li>
                <li><a href="index.php?page_layout=danhsachsp"><i class="fa fa-list-ul"></i>Quản lí sản phẩm</a></li>
                ...
                if(isset($_GET["page_layout"])){
                    switch ($_GET["page_layout"]) {
                        ...
                        case 'xoasp':include_once './xoasp.php';
                            break;
                        case 'themmoitv':include_once './themmoitv.php';
                            break;
